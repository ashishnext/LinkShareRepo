...
<script src="${resource(dir: 'js/theme/', file: 'scrollreveal/scrollreveal.min.js')}" type="text/javascript"></script>


<!-- Theme JavaScript -->
<script src="${resource(dir: 'js/theme/', file: 'magnific-popup/jquery.magnific-popup.min.js')}" type="text/javascript"></script>
